...
/**
 * @brief byte order. Make impact on on decode/encode calculations. WHere bytes are being shifted.
 * https://en.wikipedia.org/wiki/Endianness
*/

// in case of running encode/decode on different platforms,
// user should be aware that different endianness type make impact on decoded/encoded data
...
enum error_type {
	...
	STRING_TOO_BIG = -2,	/** String length is out out of allowed restriction. Encode/Decode */
	NON_ASCII_CHARACTER = -1/**< Non ASCII character provided in string, Encode[for Decode have to be added check] */
};
 ...
 * https://en.wikipedia.org/wiki/Data_compression
 ...
 @param txt_output encoded string, where compression applied
 ...
 * Decoding each sequence of 7 bits into byte, where MSB will be set to 0.
 @param txt_in input string
 @param txt_output decoded string
 @return count of bytes returned
*/
